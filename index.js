...
fruit.forEach((fruit) => {
  console.log(fruit.name); //console logs names of fruit
fruit.forEach((Seed)) => {
  console.log(fruit.Seed);

const result = fruit.filter((fruit) =>{return fruit.Seed < 100; //don't need to name, atuo-returns your contents,dont need to use return
console.log(result)});
